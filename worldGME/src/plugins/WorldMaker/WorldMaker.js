        ...
        */
        ...
        function getScript() {
            ...
            for(var i = 0; i < modelJson.worldNames.length; i++){
                scriptFile += "    cl.spawn(\"/home/reu-cat/catvehicle_ws/src/catvehicle/launch/" +
                    ...
                    "    print(\"Please type 1 to move to next simulation.\")\n"+
        ...
        function getReadMe(){
            ...
            readMe +=
                ...
                "put the launchfiles in the launch folder of same, and run the launch files for\n" +
                ...
                "user name or ROS folder location. If you want to use the bounding box plugin then\n" +
                "you must compile and make it in your own directory (see gazebo plugin tutorial for\n" +
                "this) and then do gzserver <location and name of file>.";
        ...
        "\n</include>\n<include>\n<uri>model://sun</uri>\n</include>" +
            ...
            worldFile  += "\n<gui fullscreen='0'>\n<camera name='user_camera'>\n<pose>20 -20 20 0.000000 0.6 2.356190</pose>" +
                "\n<view_controller>orbit</view_controller>\n</camera>\n</gui>\n<plugin name=\"boundingBoxPlugin\" " +
                "filename=\"libboundingBoxPlugin.so\"/></world></sdf>";
